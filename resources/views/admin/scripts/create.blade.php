        ...
        <form action="{{ route('admin.scripts.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 border-b border-zinc-100">
                <div class="space-y-1.5 md:col-span-2">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required class="block w-full px-4 py-3 rounded-xl border border-zinc-200 bg-zinc-50/50 text-zinc-900 focus:bg-white focus:border-zinc-900 focus:ring-2 focus:ring-zinc-900/20 transition-all">
                </div>
            ...
            <div class="mt-8">
                ...
                <div class="mb-4 flex flex-col sm:flex-row items-end gap-3 bg-zinc-50/80 p-4 rounded-xl border border-zinc-200">
                    <div class="flex-1 w-full">
                        <label class="block text-xs font-bold text-zinc-500 mb-1.5 uppercase tracking-wider">Gunakan Replace Template (Otomatis)</label>
