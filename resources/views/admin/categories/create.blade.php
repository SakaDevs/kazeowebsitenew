<x-admin-layout>
    ...
    <div class="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden max-w-2xl">
        <div class="p-6 border-b border-zinc-200 bg-zinc-50/50">
            <h3 class="text-lg font-bold text-zinc-900">Create Category</h3>
            <p class="text-sm text-zinc-500 font-medium mt-1">Tambahkan kategori baru. URL Slug akan dibuat secara otomatis.</p>
        </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus placeholder="Contoh: Mobile Legends"
                ...
                <p class="mt-2 text-xs text-zinc-500 font-medium">Ini akan muncul sebagai menu atau pengelompokan di website.</p>
            </div>
